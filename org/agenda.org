...
- [ ] Test 5 on loops - deadline March 18 

- [ ] 25% not bothering with non-DataCamp assignments.
- [ ] There's a new assignment - =Titanic= with ~tapply~
- [ ] I will post a couple of (simple) bonus assignments.

- [ ] Fake papers & the literature review
- [ ] DataCamp review: Utilities
- [ ] Loops finisher: ~break,~ ~next,~ ~repeat~

** DONE Sample solutions for programming assignments
...
** DONE ~while~ loops - lecture & codealong
...
** IN_PROGRESS ~apply~ functions - lecture & codealong
...
** TODO Literature Review: Fake Papers and the Sokal Hoax
