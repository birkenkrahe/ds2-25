...
- [ ] *DataCamp lessons*: Complete "Data Processing in Shell" by May 9th.

** DONE DataCamp lesson: Data Processing in Shell
...
** DONE Review: Writing functions like a pro / "Tidyverse"

*Popquiz! Time = 20 minutes - then 10 min review of the answers.*
...
** DONE Writing your own functions
...
** DONE My apologies - the price of research
#+attr_html: :width 400px :float nil:
[[../img/colloq.png]]
...
** DONE Installing and testing ~csvkit~
...
** NEXT Lecture/Practice: Data Science on the Command Line
...
7. Why is the command-line considered “agile” for data science?
   ...
   is close to the filesystem for fast access
   #+end_quote
...
10. List three reasons why the command-line is considered ubiquitous
    ...
    is used on servers and embedded systems
    #+end_quote
...
* Week 13: =SQL= Database operations on the command line with ~sql2csv~
* Week 14: Optimizing code with =C++= and ~RCpp~
