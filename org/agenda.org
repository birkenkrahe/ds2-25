...
** TODO Installing and testing ~csvkit~
...
** TODO Lecture/Practice: Data Science on the Command Line


* Week 13: Data cleaning and munging with ~xsv~ and ~csvkit~
* Week 14: =SQL= Database operations on the command line with ~sql2csv~
* Week 15: Optimizing code with =C++= and ~RCpp~
