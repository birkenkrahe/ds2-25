...
** TODO Review Questions for Monte Carlo Simulation
...
** TODO More real world problems solved with functions

- [ ] Lazy evaluation of function arguments
- [ ] Checking for missing arguments
- [ ] Using ellipses to customize plots
