...
* Week 14: It's a wrap! ~sql2csv~  & Optimizing code with =C++= and ~RCpp~
#+attr_html: :width 200px :float nil:
[[../img/wrap.png]]

- [ ] Popquiz! Pre-view for test 7 (due Tue May 6th).
- [ ] We'll finish command line data science!
- [ ] We'll take a peek at the Rcpp package.
...
- We need two volunteers to present on Thursday, May 1
...
** TODO Review "Data science on the command-line"
