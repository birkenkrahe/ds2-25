...
- [ ] *Practice:* [[https://tinyurl.com/scoping-practice-org][tinyurl.com/scoping-practice-org]]
- [ ] *Lecture*: Arguments (GitHub) with practice (GitHub)

** DONE Projects - sprint review coming soon
#+attr_html: :width 600px: 
[[../img/projects.png]]

** DONE Plot your test grades (future assignment)
#+attr_html: :width 400px:
...
** TODO Function arguments (lecture & practice)
