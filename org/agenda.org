...
*Decision time*:
- [ ] We need 2 presentations on Thursday, May 1.
- [ ] The rest of you will present next week.

*Topics*:
- [ ] *Course Evaluations*: Take 10 minutes to evaluate this course!
- [ ] *Popquiz!* Pre-view for test 7 (due Tue May 6th).
- [ ] *Finish:* We'll finish command line data science!
- [ ] *Optimize:* We'll take a peek at the Rcpp package.

** TODO Final presentations May 1, 6, 8
#+attr_html: :width 400px :float nil:
[[../img/sacrifice.png]]
...
** TODO Popquiz - Review "Data science on the command-line"
